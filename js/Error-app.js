...
this.actualizarDatos();
    this.inicializarUp = function () {
        ...
        this.calculoDeHiperPlanoNeurona();
        this.GraficarPlanoActual();
    }
    ...
    this.calculoDeHiperPlanoNeurona = function () {
        this.hiperPlanoNeurona = [];
        for (var i = 0; i <= 10; i++) {
            this.hiperPlanoNeurona.push([i, this.calculoDeRecta(i)]);
        }
    }
    ...
    this.algoritmoDeAprendizaje = function (i) {
        // this.w0 += this.fCambio * (1 - puntosProblema[i].s * this.evaluarSignoUp(dataProblema[i][0], dataProblema[i][1])) * puntosProblema[i].s * this.x0;
        // this.w1 += this.fCambio * (1 - puntosProblema[i].s * this.evaluarSignoUp(dataProblema[i][0], dataProblema[i][1])) * puntosProblema[i].s * dataProblema[i][0];
        // this.w2 += this.fCambio * (1 - puntosProblema[i].s * this.evaluarSignoUp(dataProblema[i][0], dataProblema[i][1])) * puntosProblema[i].s * dataProblema[i][1];
        ...
        // this.w0 += puntosProblema[i].s * x0;
        // this.w1 += puntosProblema[i].s * dataProblema[i][0];
        // this.w2 += puntosProblema[i].s * dataProblema[i][1];

    }

    this.GraficarPlanoActual = function () {
        this.calculoDeHiperPlanoNeurona();
this.actualizarDatos();
    ...
    this.entrenarUp = function () {
        ...
        while (this.hiperPlanoEncontrado == false) {
            for (var i = 0; i < cantidadPuntos; i++) {
                ...
                //console.log("signoUp: " + signoUp + " signoOri: "+signoOri);
                if (signoUp != signoOri) {
    ...
    this.evaluarAprendizaje = function () {
        ...
        for (var i = 0; i < cantidadPuntos; i++) {
            ...
            var signoOri = puntosProblema[i].s;
            if (signoUp === signoOri) {
                puntosAcertados.push([parseFloat(dataProblema[i][0]), parseFloat(dataProblema[i][1])]);
            } else {
                puntosErrados.push([parseFloat(dataProblema[i][0]), parseFloat(dataProblema[i][1])]);
            }
        }
...
var Generador = function () {
    ...
    this.generarPuntosEntrenamiento = function () {
        ...
        bProblema = parseFloat((Math.random() * 10).toFixed(2));
