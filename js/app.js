...
var uP = function () {
    ...
    this.pasoAPaso = function () {
        ...
        $('#evaluate').css({ 'background-color': 'lightpink', 'color': 'black', 'text-align': 'center', 'text-decoration': 'none', 'display': 'inline-block', 'cursor': 'pointer' });
        $('#load').prop("disabled", false);
        $('#load').css({ 'background-color': 'lightpink', 'color': 'black', 'text-align': 'center', 'text-decoration': 'none', 'display': 'inline-block', 'cursor': 'pointer' });
        $('#geconeval').prop("disabled", false);
        $('#geconeval').css({ 'background-color': 'lightpink', 'color': 'black', 'text-align': 'center', 'text-decoration': 'none', 'display': 'inline-block', 'cursor': 'pointer' });
        this.hiperPlanoEncontrado = false;
        ...
        console.log('Ec. Recta y=mx+b con m=' + (-this.w1 / this.w2).toFixed(2) + " y b=" + (-this.w0 / this.w2).toFixed(2));
        iteraciones++;
    ...
    this.cargarProblemaDeEvaluacion = function () {
        var myChart = Highcharts.chart('gEntrenamiento', {
            ...
            {
                type: 'line',
                name: 'Ec. Recta y=mx+b con m=' + (-this.w1 / this.w2).toFixed(2) + " y b=" + (-this.w0 / this.w2).toFixed(2),
                lineWidth: 0.5,
    ...
    this.inicializarUp = function () {
        ...
        $('#load').css({ 'background-color': 'gray', 'color': 'white', 'text-align': 'center', 'text-decoration': 'none', 'display': 'inline-block', 'cursor': 'pointer' });
        $('#entrepaso').prop("disabled", false);
        $('#entrepaso').css({ 'background-color': 'lightskyblue', 'color': 'black', 'text-align': 'center', 'text-decoration': 'none', 'display': 'inline-block', 'cursor': 'pointer' });
        $('#entreauto').prop("disabled", false);
        $('#entreauto').css({ 'background-color': 'lightskyblue', 'color': 'black', 'text-align': 'center', 'text-decoration': 'none', 'display': 'inline-block', 'cursor': 'pointer' });
        $('#evaluate').prop("disabled", true);
        $('#evaluate').css({ 'background-color': 'gray', 'color': 'white', 'text-align': 'center', 'text-decoration': 'none', 'display': 'inline-block', 'cursor': 'pointer' });
        this.w0 = Math.random();
        this.w1 = Math.random();
        this.w2 = Math.random();
    ...
    this.algoritmoDeAprendizaje = function (i) {
        this.w0 += this.fCambio * (puntosProblema[i].s - this.evaluarSignoUp(dataProblema[i][0], dataProblema[i][1])) * x0;
        this.w1 += this.fCambio * (puntosProblema[i].s - this.evaluarSignoUp(dataProblema[i][0], dataProblema[i][1])) * dataProblema[i][0];
        this.w2 += this.fCambio * (puntosProblema[i].s - this.evaluarSignoUp(dataProblema[i][0], dataProblema[i][1])) * dataProblema[i][1];
    }
    ...
    this.GraficarPlanoActual = function (signo) {
        ...
        var myChart = Highcharts.chart('gEntrenamiento', {
            ...
            {
                type: 'line',
                name: 'Ec. Recta y=mx+b con m=' + (signo * this.w1 / this.w2).toFixed(2) + " y b=" + (signo * this.w0 / this.w2).toFixed(2),
                lineWidth: 0.5,
                color: colorPuntosRecta,
                data: this.hiperPlanoNeurona
            }
    ...
    this.evaluarAprendizaje = function () {
        ...
        var chartSolucion = Highcharts.chart('gEntrenamiento', {
            ...
            subtitle: {
                text: 'Nivel de precision de neurona ' + (puntosAcertados.length-1) * 100 / (cuadrado*cuadrado) + ' %'
            },
            xAxis: {
                title: {
                    text: 'Eje X'
...
// =========================Generador de poblema de la aplicacion==============================
var Generador = function () {
    // Restablecer Variables
    this.reestablecerProblema = function () {
        $('#geconeval').prop("disabled", true);
        $('#geconeval').css({ 'background-color': 'gray', 'color': 'white', 'text-align': 'center', 'text-decoration': 'none', 'display': 'inline-block', 'cursor': 'pointer' });
        rectaDeGenerador = [];
        puntosProblema = [];
        dataProblema = []
        pointsBlue = [];
        ...
        var myChart = Highcharts.chart('gProblema', {
            ...
            },
            {
                ...
                color: colorPuntosRecta,
                lineWidth: 0.5,
                data: [[0, 1], [1, 1.5], [2, 2], [3, 2.5], [4, 3], [5, 3.5], [6, 4], [7, 4.5], [8, 5], [9, 5.5], [10, 6]]
            }
            ]
        });
    ...
    this.generarPuntosEntrenamiento = function () {
        ...
        $('#iniciarup').css({ 'background-color': 'lightgreen', 'color': 'black', 'text-align': 'center', 'text-decoration': 'none', 'display': 'inline-block', 'cursor': 'pointer' });
        $('#reset').prop("disabled", false);
        $('#reset').css({ 'background-color': 'lightgreen', 'color': 'black', 'text-align': 'center', 'text-decoration': 'none', 'display': 'inline-block', 'cursor': 'pointer' });
        rectaDeGenerador = [];
        puntosProblema = [];
        dataProblema = []
        pointsBlue = [];
...
$(function () {
    ...
    $('#reset').css({ 'background-color': 'gray', 'color': 'white', 'text-align': 'center', 'text-decoration': 'none', 'display': 'inline-block', 'cursor': 'pointer' });
    $('#entrepaso').prop("disabled", true);
    $('#entrepaso').css({ 'background-color': 'gray', 'color': 'white', 'text-align': 'center', 'text-decoration': 'none', 'display': 'inline-block', 'cursor': 'pointer' });
    $('#entreauto').prop("disabled", true);
    $('#entreauto').css({ 'background-color': 'gray', 'color': 'white', 'text-align': 'center', 'text-decoration': 'none', 'display': 'inline-block', 'cursor': 'pointer' });
    $('#load').prop("disabled", true);
    $('#load').css({ 'background-color': 'gray', 'color': 'white', 'text-align': 'center', 'text-decoration': 'none', 'display': 'inline-block', 'cursor': 'pointer' });
    $('#geconeval').prop("disabled", true);
    $('#geconeval').css({ 'background-color': 'gray', 'color': 'white', 'text-align': 'center', 'text-decoration': 'none', 'display': 'inline-block', 'cursor': 'pointer' });
    ...
    $('#iniciarup').css({ 'background-color': 'gray', 'color': 'white', 'text-align': 'center', 'text-decoration': 'none', 'display': 'inline-block', 'cursor': 'pointer' });
